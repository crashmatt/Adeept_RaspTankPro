...
try:
	os.system("cd " + startup_path + " && sudo make install")
except:
	pass
...
startup_path = '//home/' + username + '/startup.sh'

try:
	os.system('sudo touch ' + startup_path)
	with open(startup_path,'w') as file_to_write:
...
os.system('sudo chmod 777 ' + startup_path)
